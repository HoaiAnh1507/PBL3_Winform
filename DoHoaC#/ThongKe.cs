...
namespace DoHoaC_
{
    public partial class ThongKe : UserControl
    {
        ...
        private void buttonXem_Click(object sender, EventArgs e)
        {
            ...
            {
                // Thêm điểm dữ liệu cho Series
                string xValue = row[0].ToString(); // Xác định giá trị trục X, có thể là ngày, tháng, năm...
                double yValue = Convert.ToDouble(row[1]); // Giá trị trục Y, tổng doanh thu
